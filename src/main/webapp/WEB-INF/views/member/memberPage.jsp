...
<body>
	...
	<div style="padding: 103px 10%">
		<div class="mp_myInfoBox">
			<div class="mp_pic">
				<img
					src="${pageContext.request.contextPath}/resources/img/ico-leaf.svg">
			</div>
			<div class="mp_me">
				<strong class="mp_me_strong">${memberVO.name}</strong> <span
					class="mp_me_span">${memberVO.email}</span>
			</div>
			<div class="mp_num">
				<span class="mp_num_span">수령예정</span> <em class="mp_num_em">0</em>
			</div>
			<div class="mp_num">
				<span class="mp_num_span">총 주문회수</span> <em class="mp_num_em">0</em>
			</div>
		</div>
		...
		<c:if test="${memberVO.isFoodTruck eq '1'}">
			<div class="toggleWrap" style="float: right;">
				<span class="storeOpen">영업 시작</span> <input type="checkbox"
					id="toggle_alarm" name="" value="0" />
				<div>
					<label id="btn-toggle" for="toggle_alarm"> <span></span>
					</label>
				</div>
			</div>
		</c:if>
		...
		<div class="mp_myInfoNav">
			<aside class="mp_myInfoNav_aside">
				...
				<ul class="mp_myInfoNav_ul">
					<li id="default" class="mp_myInfoNav_li"><a
						class="mp_myInfoNav_a" href="#">주문/결제 내역</a></li>
					<li id="myReview" class="mp_myInfoNav_li"><a
						class="mp_myInfoNav_a" href="#">나의 후기</a></li>
					<li id="memberUpdate" class="mp_myInfoNav_li"><a
						class="mp_myInfoNav_a" href="#">회원정보 수정</a></li>

					<c:if test="${memberVO.isFoodTruck eq '0'}">
						<li id="marketJoin" class="mp_myInfoNav_li"><a
							class="mp_myInfoNav_a">판매자 신청</a></li>
					</c:if>
					
					<c:if test="${memberVO.isFoodTruck eq '1'}">
						<li id="marketPage" class="mp_myInfoNav_li"><a
							class="mp_myInfoNav_a" href="#">마켓 정보 수정</a></li>
						<li id="menuAdd" class="mp_myInfoNav_li"><a
							class="mp_myInfoNav_a" href="#">메뉴 & 카테고리 추가</a></li>
						<li id="menuUpdate" class="mp_myInfoNav_li"><a
							class="mp_myInfoNav_a" href="#">메뉴 & 카테고리 수정</a></li>
					</c:if>

					<li id="member_delete" class="mp_myInfoNav_li"><a
						class="mp_myInfoNav_a">탈퇴하기</a></li>
					<li id="li5" class="mp_myInfoNav_li"><a class="mp_myInfoNav_a"
	...
	<script type="text/javascript">
														...
														.coord2Address(
																...
																function(
																	...
																	if (status === kakao.maps.services.Status.OK) {
																		...
																		$
																				.post(
																						"../market/marketGeoUpdate",
																						{
																							userNum : '${memberVO.num}',
		...
		$('#myReview').click(
				function() {
					...
					$.get("../review/myReviewList?num=${memberVO.num}",
							function(result) {
								console.log("result : " + result);
